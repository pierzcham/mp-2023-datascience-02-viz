---
title: "HW - Airbnb listings in Edinburgh"
output: 
  tufte::tufte_html:
    css: ../lab.css
...
Knit the R Markdown document `hw.Rmd` to `md` (github_document).
...
If they are not already installed, you need to run command:
...
Then, you can load them by running the following in your Console:
...
You can also find this information [here](https://tidyverse.github.io/dsbox/reference/index.html).
