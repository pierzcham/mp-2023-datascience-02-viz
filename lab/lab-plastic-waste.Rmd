...
Knit the R Markdown `lab.Rmd` to md (github_document) document. Make sure it compiles without errors. 
...
Once you're done, check to make sure your latest changes are on your GitHub repository.
